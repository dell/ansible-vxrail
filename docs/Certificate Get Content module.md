...
Synopsis
--------
This module will return the content of certificate file according to the fingerprint parameter.
  
Supported Endpoints
--------

* GET /trust-store/certificates/{fingerprint}
                ...
                <div style="font-size: small">
                    ...
                    <span style="color: red">required=true</span>                    </div>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div></div>
                                        <div>Provide a fingerprint to find the content of corresponding certificate in VXM trust store</div>
                                                    </td>
        </tr>
