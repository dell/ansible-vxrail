VC Mode Information Module for Dell EMC VxRail
=================
### Product Guide
...
- Module dellemc_vxrail_vc_getmode.py can call any existing version of /vc/mode
- Details on execution of module dellemc_vxrail_vc_getmode.py can be checked in the logs /tmp/vxrail_ansible_vc_mode_info.log
...
``` yaml+jinja
  - name: Retrieve VC Mode Information
...
<table border=0 cellpadding=0 class="documentation-table">
    <tr>
        ...
        <th width="100%">Description</th>
            ...
            <td>When VC and PSC mode information exists.</td>
            <td>all</td>
            <td>
                                        <div>The current vCenter and PSC mode information.</div>
                                    <br/>
                                </td>
        </tr>
...
<tr>
            ...
            <td>v1</td>
            <td>
                                        <div>The PSC mode information</div>
                                    <br/>
                                </td>
        </tr>
<tr>
            ...
            <td>v1</td>
            <td>
                                        <div>The VC mode information</div>
                                    <br/>
                                </td>
        </tr>
                    </table>
