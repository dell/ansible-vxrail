**Customer Supplied Hosts Module for Dell EMC VxRail**
=========================================
### Product Guide
...
Notes
-----
- Make sure your VxRail environment supports the POST system/initialize/customer-supplied-host API
- Some VxRail setup options might be limited when marking the Day1 setup with Customer-Supplied hosts.
- This module will still return successfully if any of the input management ip nodes are queried successfully. 
- Module dellemc_vxrail_customer_supplied_hosts.py can call any existing version of system/initialize/customer-supplied-host API
- Details on execution of module dellemc_vxrail_customer_supplied_hosts.py can be checked in the logs /tmp/vxrail_ansible_customer_supplied_hosts.log
...
``` yaml+jinja
  - name: Return nodes by customer supplied management IP. Version specified by api_version_number
...
<table border=0 cellpadding=0 class="documentation-table">
    ...
    <tr>
        <td colspan="5">
            ...
            <b>Customer_Supplied_Hosts_API</b>
        ...
        <td>When any nodes could be queried</td>
        <td>v1</td>
        <td>
            <div>Details about the retrieved hosts information. </div>
            <br/>
        </td>
    </tr>
    <tr>
<td class="elbow-placeholder">&nbsp;</td>
        ...
        <td>v2</td>
        <td>
            <div>Response version of the successfully-queried customer supplied nodes</div>
            <br/>
        </td>
    </tr>
                </tr>
