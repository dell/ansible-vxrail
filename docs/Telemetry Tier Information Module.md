**Telemetry Tier Information Module for Dell EMC VxRail**
=========================================
### Product Guide 2.0.0
...
Synopsis
--------
This module will return the system's telemetry tier information.
...
- Can check Log file /tmp/vxrail_get_telemetry_tier.log for more details about execution result.
...
``` yaml+jinja
  - name: Retrieves VxRail Telemetry Tier. Version specified by api_version_number
