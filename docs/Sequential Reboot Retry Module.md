**Sequential Reboot Retry Module for Dell EMC VxRail**
=========================================
### Product Guide
...
* POST /sequential-reboot/{request_id}/retry
                ...
                <div style="font-size: small">
                    ...
                    <span style="color: red">required=true</span>                    </div>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div></div>
                                        <div>The task ID of reboot action that need to be retried</div>
                                                    </td>
        </tr>
<tr>
                                                            <td colspan="1">
...
Notes
-----
- This module calls any existing version of the /sequential-reboot/{request_id}/retry api, please ensure your VxRail cluster supports this API.
- Can check Log file /tmp/vxrail_ansible_sequential_reboot_retry.log for more details about execution result.
