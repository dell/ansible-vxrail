...
This module will retrieve VxRail Support Logs Information.
...
- Module dellemc_vxrail_support_logs_get.py calls any existing version of Get /support/logs API
- Details on execution of module dellemc_vxrail_support_logs_get.py can be checked in the logs /tmp/vxrail_log_support_logs_get.log
