**Certificate Update Module for Dell EMC VxRail**
=========================================
### Product Guide 1.4.0
...
Supported Endpoints
--------
* POST /certificates/import-vxm

Parameters
----------
<details><summary>POST /v2/certificates/import-vxm</summary>
                ...
                <div style="font-size: small">
                    ...
                    <span style="color: red">required=true</span>                    </div>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div></div>
                                        <div>The contents of the private key in PEM format. Only an RSA private key is allowed.</div>
                                        <div></div>
                                                    </td>
        </tr>
<tr>
                ...
                <div style="font-size: small">
                    ...
                    <span style="color: red">required=true</span>                    </div>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div></div>
                                        <div>The password for the new .pfx file. It is deprecated from 7.0.380 release.</div>
                                        <div></div>
                                                    </td>
        </tr>
<tr>
                ...
                <div style="font-size: small">
                    ...
                    <span style="color: red"></span>                    </div>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div></div>
                                        <div>Time out value for updating certificate, the default value is 600 seconds</div>
                                        <div></div>
                                                    </td>
        </tr>
<tr>
...
<details><summary>POST /v3/certificates/import-vxm</summary>
<table border=0 cellpadding=0 class="documentation-table">
    <tr>
        <th colspan="1">Parameter</th>
        <th>Choices/<font color="blue">Defaults</font></th>
                ...
                <div style="font-size: small">
                    ...
                    <span style="color: red">required=true</span>                    </div>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div></div>
                                        <div>VC admin account for invoke VC API to send the new root cert to VC trust store.</div>
                                        <div></div>
                                                    </td>
        </tr>
<tr>
                ...
                <div style="font-size: small">
                    ...
                    <span style="color: red">required=true</span>                    </div>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div></div>
                                        <div>VC admin password for invoke VC API to send the new root cert to VC trust store.</div>
                                        <div></div>
                                                    </td>
        </tr>
<tr>
...
- Module dellemc_vxrail_certificate_update.py can call any existing version of /certificates/import-vxm API
- Details on execution of module dellemc_vxrail_certificate_update.py can be checked in the logs /tmp/vxrail_ansible_certificate_update.log
...
``` yaml+jinja
  - name: Update the VxRail Manager certificate with v2/certificates/import-vxm API
    dellemc_vxrail_certificate_update:
        ...
        vcpasswd: "{{ vcpasswd }}"
        cert: "{{ cert }}"
        root_cert_chain: "{{ root_cert }},{{ intermediate_cert }}"
    ...
    <tr>
        ...
        <th width="100%">Description</th>
            ...
            <td>
                ...
                <b>certificate_update_information</b>
                <a class="ansibleOptionLink" href="#return-host_details" title="Permalink to this return value"></a>
                <div style="font-size: small">
                  <span style="color: purple">complex</span>
                                      </div>
                                </td>
            <td>When the certificate updating task be created</td>
            <td>
                                        <div>Updating task ID</div>
                                    <br/>
                                </td>
        </tr>
                                    <tr>
            ...
            <td>success</td>
            <td>
                                        <div>Return the task ID of the certificate updating task.</div>
<tr>
                                <td class="elbow-placeholder">&nbsp;</td>
                            <td colspan="1">
                <div class="ansibleOptionAnchor" id="return-host_details/bw_limit"></div>
