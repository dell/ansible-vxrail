**System Datastore ID Update Module for Dell EMC VxRail**
=========================================
### Product Guide
...
Synopsis
--------
This module will update the datastore ID.

Supported Endpoints
--------

* PATCH /system/datastore/id
                ...
                <div style="font-size: small">
                    ...
                    <span style="color: red">required=true</span>                    </div>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div></div>
                                        <div>The datastore name used to update datastore id</div>
                                                    </td>
        </tr>
<tr>
                                                            <td colspan="1">
...
Notes
-----
- This module calls any existing version of the /system/datastore/id api, please ensure your VxRail cluster supports this API.
- Can check Log file /tmp/vxrail_ansible_datastore_update.log for more details about execution result.
...
``` yaml+jinja
  - name: Update datastore ID. Version specified by api_version_number
...
<table border=0 cellpadding=0 class="documentation-table">
    <tr>
        ...
        <th width="100%">Description</th>
                ...
                <tr>
                            <td colspan="3">
                <div class="ansibleOptionAnchor" id="return-datastore_id"></div>
                <b>datastore_id</b>
                <a class="ansibleOptionLink" href="#return-datastore_id" title="Permalink to this return value"></a>
                <div style="font-size: small">
