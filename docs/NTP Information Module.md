**System NTP Information Module for Dell EMC VxRail**
=========================================
### Product Guide 1.4.0
...
- Can check Log file /tmp/vxrail_ansible_system_get_ntp.log for more details about execution result.
...
``` yaml+jinja
  - name: Get System NTP Information. Version specified by api_version_number
...
<table border=0 cellpadding=0 class="documentation-table">
    <tr>
        ...
        <th width="100%">Description</th>
            ...
            <td>v1</td>            
            <td>
                                        <div>Details about system NTP of VxRail cluster</div>
                                    <br/>
                                </td>
        </tr>
                                            <tr>
