...
DOCUMENTATION = r'''
---
module: dellemc_vxrail_cluster_rmhost
...
LOGGER = utils.get_logger("dellemc_vxrail_cluster_rmhost", LOG_FILE_NAME, log_devel=logging.DEBUG)
...
class VxRailRemoveHost():
    ...
    def get_versioned_response(self, api_instance, module_path, node_json):
        ...
        call_string = self.api_version_string + '_cluster_remove_host_post'
        LOGGER.info("Using utility method: %s\n", call_string)
        api_cluster_remove_host_post = getattr(api_instance, call_string)
        request_body = node_json
        return api_cluster_remove_host_post(request_body)
